...
| P2 | Important product-shape exploration that should not block first stored-sequence controller decisions | `research-live-trigger-sample-routing` |
...
| License review/outreach | Open test fixtures | Needed before third-party music/session fixtures are committed or redistributed |
...
| Deferred hardware access | Assimil8or-related routing | Not available now; keep as later external-sampler research |
...
| Pass 2: Test and tooling support | Prepare validation inputs and agent workflow assumptions | `research-open-test-music-fixtures`, `investigate-agent-control-surface` | Web/docs/source review, license review |
...
| Pass 4: Product expansion research | Explore future live cue/sample/show-control workflows | `research-live-trigger-sample-routing` | Web/domain research first, later hardware/software integration if prioritized |
