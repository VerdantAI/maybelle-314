...
- May guide ordering for `decide-base-platform`, `research-daw-interchange-options`, `investigate-es9-config-profiles`, `investigate-pi-port-topology`, `investigate-agent-control-surface`, `research-open-test-music-fixtures`, `research-live-trigger-sample-routing`, `research-synced-lfo-sampler-authoring`, `research-touchscreen-emulation-and-ux`, `research-bluetooth-control-channel`, `research-performance-backstage-modes`, `research-performance-router-screen`, and `research-backstage-gear-registry`.
